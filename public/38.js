...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/assets/js/views/Approvals/Workflow/Stage/Add.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/assets/js/views/Approvals/Workflow/Stage/Add.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    save: function save() {
      ...
      var url = '/api/wizpack/workflowStages',
          data = this.form,
          serviceName = 'workflowStages';
      this.addRecord(url, data, serviceName).then(function (response) {
        _this.showModal = false;
        _this.selectedWorkflowType = null;
        _this.selectedWorkflowStageType = null;
        _this.form = {};
      });
    },
    getWorkflowTypeValue: function getWorkflowTypeValue(value) {
      this.form.workflow_type_id = value.id;
    },
    clearWorkflowTypeInput: function clearWorkflowTypeInput() {
      this.selectedWorkflowType = null;
    },
    getWorkflowStageTypesValue: function getWorkflowStageTypesValue(value) {
      this.form.workflow_stage_type_id = value.id;
    },
    clearWorkflowStageTypeInput: function clearWorkflowStageTypeInput() {
      this.selectedWorkflowStageType = null;
    },
    getWorkflowTypes: function getWorkflowTypes() {
      var _this2 = this;

      this.getRecord('/api/wizpack/workflowType', {
        all: true
      }, 'Workflow types').then(function (response) {
        _this2.workflowTypes = response.data.data;
      });
    },
    getWorkflowStageTypes: function getWorkflowStageTypes() {
      var _this3 = this;

      this.getRecord('/api/wizpack/workflowStageTypes', {
        all: true
      }, 'Workflow Stage types').then(function (response) {
        _this3.workflowStageTypes = response.data.data;
      });
    }
  },
  created: function created() {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/assets/js/views/Approvals/Workflow/Stage/Add.vue?vue&type=template&id=7a42c95c&":
/*!*********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/assets/js/views/Approvals/Workflow/Stage/Add.vue?vue&type=template&id=7a42c95c& ***!
  \*********************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
                                                    ...
                                                    return [
                                                      _c(
                                                        "v-select",
                                                        {
                                                          ...
                                                          on: {
                                                            input:
                                                              _vm.getWorkflowTypeValue,
                                                            "search:focus":
                                                              _vm.clearWorkflowTypeInput
                                                          },
                                                          scopedSlots: _vm._u(
                                                            [
                                                              {
                                                          ...
                                                          model: {
                                                            value:
                                                              _vm.selectedWorkflowType,
                                                            callback: function(
                                                              $$v
                                                            ) {
                                                              _vm.selectedWorkflowType = $$v
                                                            },
                                                            expression:
                                                      ...
                                                      _c(
                                                        "v-select",
                                                        {
                                                          attrs: {
                                                            filterable: true,
                                                            options:
                                                              _vm.workflowStageTypes
                                                          },
                                                          on: {
                                                            input:
                                                              _vm.getWorkflowStageTypesValue,
                                                            "search:focus":
                                                              _vm.clearWorkflowStageTypeInput
                                                          },
                                                          scopedSlots: _vm._u(
                                                            [
                                                              {
                                                          ...
                                                          model: {
                                                            value:
                                                              _vm.selectedWorkflowStageType,
                                                            callback: function(
                                                              $$v
                                                            ) {
                                                              _vm.selectedWorkflowStageType = $$v
                                                            },
                                                            expression:
                                                              "selectedWorkflowStageType"
                                                          }
                                                        },
                                                        [
                                                          _c(
...
/***/ "./resources/assets/js/views/Approvals/Workflow/Stage/Add.vue":
/*!********************************************************************!*\
  !*** ./resources/assets/js/views/Approvals/Workflow/Stage/Add.vue ***!
  \********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Add_vue_vue_type_template_id_7a42c95c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Add.vue?vue&type=template&id=7a42c95c& */ "./resources/assets/js/views/Approvals/Workflow/Stage/Add.vue?vue&type=template&id=7a42c95c&");
/* harmony import */ var _Add_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Add.vue?vue&type=script&lang=js& */ "./resources/assets/js/views/Approvals/Workflow/Stage/Add.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Add_vue_vue_type_template_id_7a42c95c___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Add_vue_vue_type_template_id_7a42c95c___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/assets/js/views/Approvals/Workflow/Stage/Add.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/assets/js/views/Approvals/Workflow/Stage/Add.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************!*\
  !*** ./resources/assets/js/views/Approvals/Workflow/Stage/Add.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Add_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/babel-loader/lib??ref--4-0!../../../../../../../node_modules/vue-loader/lib??vue-loader-options!./Add.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/assets/js/views/Approvals/Workflow/Stage/Add.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Add_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/assets/js/views/Approvals/Workflow/Stage/Add.vue?vue&type=template&id=7a42c95c&":
/*!***************************************************************************************************!*\
  !*** ./resources/assets/js/views/Approvals/Workflow/Stage/Add.vue?vue&type=template&id=7a42c95c& ***!
  \***************************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Add_vue_vue_type_template_id_7a42c95c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../../node_modules/vue-loader/lib??vue-loader-options!./Add.vue?vue&type=template&id=7a42c95c& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/assets/js/views/Approvals/Workflow/Stage/Add.vue?vue&type=template&id=7a42c95c&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Add_vue_vue_type_template_id_7a42c95c___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Add_vue_vue_type_template_id_7a42c95c___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
