    ...
    addRecord: function addRecord(url, formData, serviceName) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        axios.post(url, formData).then(function (response) {
          ...
          _this2.$toastr.s(serviceName + " added successfully");

          Event.fire('show-loader', false);
          Event.fire('show-modal', false);
        })["catch"](function (error) {
          reject(error.response);
          Event.fire('show-loader', false);

          _this2.flashError(serviceName + " not added" + error);
        });
      });
    },
    getRecord: function getRecord(url, params, serviceName) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        axios.get(url, {
          ...
          _this3.flashError(serviceName + " not retrieved" + error);
        });
      });
    }
  }
