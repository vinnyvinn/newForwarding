            ...
            <div class="card">
                <div class="card-body">
                    <div class="row card-title  ">
                        <div class="col-md-4 ">
                            <add-workflow-stage-types-component></add-workflow-stage-types-component>
                        </div>
                        <h4 class="col-md-4  text-center">Stages Types</h4>
                        <div class="col-md-4 ">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            deleteShipment(id){
                let url = "api/wizpack/workflowStageTypes/"+id;
