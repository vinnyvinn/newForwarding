            ...
            <div class="card">
                <div class="card-body">
                    <div class="row card-title  ">
                        <div class="col-md-4 ">
                            <add-shipment-sub-type-component></add-shipment-sub-type-component>
                        </div>
                        <h4 class="col-md-4  text-center">Shipment Sub-Types</h4>
                        <div class="col-md-4 ">
...
<script>
    ...
    import AddShipmentSubTypeComponent from "./Add";

    export default {
        mixins: [vueTableMixin, TableMixinsActions],
        components: {
            AddShipmentSubTypeComponent,
            Vuetable,
            VuetablePagination,
        ...
        methods: {
            ...
            deleteShipment(id) {
                let url = "/api/shipmentSubTypes/" + id;
