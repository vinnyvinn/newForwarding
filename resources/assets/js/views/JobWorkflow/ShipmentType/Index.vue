            ...
            <div class="card">
                <div class="card-body">
                    <div class="row card-title  ">
                        <div class="col-md-4 ">
                            <add-shipment-type-component></add-shipment-type-component>
                        </div>
                        <h4 class="col-md-4  text-center">Shipment Types</h4>
                        <div class="col-md-4 ">
...
<script>
    ...
    import AddShipmentTypeComponent from "./Add";

    export default {
        mixins: [vueTableMixin,TableMixinsActions],
        components: {
            AddShipmentTypeComponent,
            Vuetable,
            VuetablePagination,
