                ...
                <div class="row">
                        ...
                        <div class="pull-right">
                            <div class="pull-right">
                                ...
                                <address id="client_details">
                                    <br>
                                    <p class="pull-right"><b>Date : </b> {{ \Carbon\Carbon::now()->format('d-M-y') }}
                                    </p>
                                </address>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="form-group"><label for="">PO Number</label>
                                        <input type="text" readonly required value="LPO000{{ $poNumber }}" name="po_no"
                                               id="po_no" class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-5">
                                    <div class="form-group"><label for="">PO Date</label>
                                        <input type="text" required value="" name="po_date" id="po_date"
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <button style="margin-top: 26px" class="btn btn-primary pull-right">Add Detail
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive m-t-40" style="clear: both;">
                            <h3>Select Item | <code style="color: green" id="currency"></code> <span id="notification"
                                                                                                     class="pull-right"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select name="service" required id="service" onchange="populateItem()"
                                                        class="form-control select2"
                                                        data-placeholder="Search and select item">
                                                    <option value="">Search and select service</option>
                                                    @foreach($sservices as $service)
                                                        <option value="{{$service}}">{{ ucwords($service->Description_2) }}
                                                            ~ {{ ucwords($service->Description_1) }}
                                                            ~ {{ ucwords($service->Description_3) }} <b
                                                                    style="text-align: right">{{ in_array($service->StockLink,$qitem) ? 'In Project' : 'Not In Project' }} </b>
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <input type="number" required id="service_units" name="service_units"
                                                       placeholder="Quantity" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <input type="number" required id="selling_price" name="selling_price"
                                                       placeholder="Rate" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <select name="tax" required id="tax" data-placeholder="Select tax"
                                                        class="form-control select2">
                                        ...
                                        <div class="col-sm-2">
                                            <button class="btn btn-block btn-sm btn-primary" onclick="addItem()"><i
