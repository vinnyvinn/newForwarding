            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="card-body">
                        <!-- Row -->
                        <div class="row">
                            <div class="col-8"><h2>{{ count(\App\Lead::where('status',0)->get()) }} <i
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="card-body">
                        <!-- Row -->
                        <div class="row">
                            <div class="col-8"><h2 class="">{{ count(\App\Quotation::all()) }} <i
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="card-body">
                        <!-- Row -->
                        <div class="row">
                            <div class="col-8"><h2>$ {{ number_format(\App\QuotationService::all()->sum('total') )}} <i
                                            class="ti-angle-up font-14 text-success"></i></h2>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="card-body">
                        <!-- Row -->
                        <div class="row">
                            <div class="col-8"><h2>{{ \App\Cargo::all()->sum('weight') }} MT <i
                                            class="ti-angle-up font-14 text-success"></i></h2>
                            ...
                            @foreach($v_notifications as $notification)
                                <li>
                                    ...
                                    <a href="{{ url('/notifications/'.$notification->id) }}"
                                       class="btn btn-xs btn-primary"><i class="fa fa-eye"></i></a> <span
                                            class="text-muted"> 1 mins</span>
                                </li>
                            @endforeach
                        </ul>
                    </div>
