...
<div class="col-md-12">
    <div class="pull-left">
        <address>
            ...
            <h4>Contact Person
                : {{ mb_strimwidth(ucwords($quotation->customer ? $quotation->customer->Contact_Person :''),0,16,"...") }} </h4>
...
<div class="modal fade bs-example-modal-details" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
                    ...
                    <form class="form-material m-t-40" action="{{url('update-quote')}}" method="post">
                        <div class="row">
                            ...
                            <input type="hidden" name="customer_id"
                                   value="{{$quotation->customer ? $quotation->customer->id :''}}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" required id="Contact_Person" name="Contact_Person"
                                           class="form-control"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" required id="Telephone" name="Telephone" class="form-control"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" required id="bl_no" name="bl_no" class="form-control"
                                           value="{{$quotation->cargo->bl_no}}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" required id="cargo_name" name="cargo_name" class="form-control"
                                           value="{{$quotation->cargo->cargo_name}}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="vessel_name">VESSEL/DSTN</label>
                                    <input type="text" required id="vessel_name" name="vessel_name" class="form-control"
                                           value="{{$quotation->cargo->vessel_name}}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="cargo_qty">QUANTITY</label>
                                    <input type="number" required id="cargo_qty" name="cargo_qty" class="form-control"
                                           value="{{$quotation->cargo->cargo_qty}}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="cargo_weight">WEIGHT</label>
                                    <input type="text" required id="cargo_weight" name="cargo_weight"
                                           class="form-control" value="{{$quotation->cargo->cargo_weight}}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="container_no">C'NER</label>
                                    <input type="text" required id="container_no" name="container_no"
                                           class="form-control" value="{{$quotation->cargo->container_no}}">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="consignee_name">CONSIGNEE</label>
                                    <input type="text" required id="consignee_name" name="consignee_name"
                                           class="form-control" value="{{$quotation->cargo->consignee_name}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-danger waves-effect pull-left"
                                            data-dismiss="modal" style="margin-top: -16px">Close
                                    </button>
                                </div>
                            </div>
                        </div>
