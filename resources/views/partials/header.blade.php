        ...
        <div class="navbar-collapse">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted text-muted waves-effect waves-dark" href=""
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-bell"></i>
                            <div class="notify"> {!! isset($v_notifications) && count($v_notifications) > 0 ? '<span class="heartbit"></span><span class="point"></span>' : '' !!} </div>
                        </a>
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="message-center">
                                        @if(isset($v_notifications))
                                            @foreach($v_notifications as $notification)
                                                <a href="{{ url('/notifications/'.$notification->id) }}">
                                                    <div class="btn btn-danger btn-circle"><i class="fa fa-bell"></i>
                                                    </div>
                                                    <div class="mail-contnet">
                                                        <h5>{{ ucwords($notification->title) }}</h5> <span
                                                                class="mail-desc">{{ ucfirst($notification->text) }}</span>
                                                    </div>
                                                </a>
                                            @endforeach
                                        @endif
            ...
            <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    ...
                                    @endcan
                                    <li>
                                        <a href="{{ url('companies#/company/profile') }}">Settings
                                        </a>
                                    </li>
                                </ul>
                            </div>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href=""
                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        {{ \Illuminate\Support\Facades\Auth::guest() ? 'Guest' : Auth::user()->name }} <i
                        ...
                        <ul class="dropdown-user">
                            ...
                            <li>
                                <div class="dw-user-box">
                                    <div class="u-text">
                                        {{ \Illuminate\Support\Facades\Auth::guest() ? 'Guest' : Auth::user()->name }}
