                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required id="driver_name" name="driver_name"
                                               class="form-control" placeholder="Driver Name">
                                    </div>
                                    <div class="form-group">
                                        <label for="truck_no">Track Number</label>
                                        <input type="text" required id="truck_no" name="truck_no" class="form-control"
                                               placeholder="Track Number">
                                    </div>
                                    <div class="form-group">
                                        <label for="container_reg">Container Number</label>
                                        <input type="text" required id="container_reg" name="container_reg"
                                               class="form-control" placeholder="Container Number">
                                    </div>
                                    <div class="form-group">
                                        <label for="tonne">Tonne</label>
                                        <input type="text" required id="tonne" name="tonne" class="form-control"
                                               placeholder="Tonne">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @if($transport->contracts->contract_type == 'rates')
                                        <div class="form-group"><label for="rates">Rates</label>
                                            <select name="rates" id="rates" onchange="changeBuying(this)"
                                                    class="form-control">
                                                @foreach($transport->contracts->slubs as $slub)
                                                    <option value="{{$slub}}">{{ $slub->from }} - {{ $slub->to }}
                                                        @ {{ $slub->charges }} USD in {{ $slub->t_round }} days
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="buying" name="buying" readonly class="form-control"
                                                   placeholder="Buying">
                                        </div>
                                    @else
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="buying" name="buying" value="{{ $transport->contracts->contract_type == 'open' ? $transport->contracts->value :
                                                        ($transport->contracts->contract_type == 'per_wgt' ? ($transport->contracts->value * $transport->cargo_weight) : ($transport->contracts->value * $transport->distance))}}"
                                                   readonly class="form-control" placeholder="Buying">
                                        </div>
                                    @endif

                                    <input type="hidden" id="bill_of_landing_id" value="{{$transport->id}}"
                                           name="bill_of_landing_id" class="form-control">
                                    <div class="form-group">
                                        <label for="cost">Selling </label>
                                        <input type="text" required id="cost" name="cost" class="form-control"
                                               placeholder="Cost">
                                    </div>
                                    <div class="form-group">
                                        <label for="depart">Departure Date </label>
                                        <input type="datetime-local" required id="depart" name="depart"
