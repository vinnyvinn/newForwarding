        ...
        <div class="row">
            @if($quotation->status == \Esl\helpers\Constants::LEAD_QUOTATION_PENDING)
                <div class="card card-body printableArea">
                    <h3 class="text-center">Quotation {{ $quotation->status }}</h3>
                    <br>
                    ...
                    <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-4 pull-right">
                                            <div class="pull-right">
                                                ...
                                                <button onclick="storeServiceData()" class="btn btn-primary pull-right">
                                                    Update Quotation
                                                </button>
                                            </div>
                                        </div>
                                                ...
                                                <tr id="{{$service->id}}">
                                                    ...
                                                    <td class="text-right">
                                                        <button data-toggle="modal"
                                                                data-target=".bs-example-modal-lg{{$service->id}}"
                                                                class="btn btn-xs btn-primary">
                                                            <i class="fa fa-pencil"></i>
                                                        </button>
                                                        <div class="modal fade bs-example-modal-lg{{$service->id}}"
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="col-12">
                                                                            <form style="text-align: left !important;"
                                                                                  ...
                                                                                  onsubmit="event.preventDefault(); submitForm(this, '/update-service');"
                                                                                  action="" method="post">
                                                                                {{ csrf_field() }}
                                                                                <div class="row">
                                                                                    <div class="col-sm-12">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="text" required
                                                                                                   id="qt{{$service->id}}"
                                                                                                   onkeyup="updateServiceTotal(this,'{{$service->rate}}')"
                                                                                                   value=""
                                                                                                   name="total_units"
                                                                                                   class="form-control"
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label for="tax{{$service->id}}">Select
                                                                                                Tax</label>
                                                                                            <select style="width: 100% !important;"
                                                                                                    name="taxs"
                                                                                                    onchange="onTaxChange('tax{{$service->id}}')"
                                                                                                    required
                                                                                                    id="tax{{$service->id}}"
                                                                                                ...
                                                                                                @foreach($taxs as $tax)
                                                                                                    <option value="{{$tax}}">{{ ucwords($tax->Description) }}
                                                                                                        - {{ $tax->TaxRate }}
                                                                                                        %
                                                                                                    </option>
                                                                                                @endforeach
                                                                                        ...
                                                                                        <input type="hidden"
                                                                                               ...
                                                                                               value="{{ $service->id }}">
                                                                                        <input type="hidden"
                                                                                               id="tax_code{{$service->id}}"
                                                                                               name="tax_code" value="">
                                                                                        <input type="hidden"
                                                                                               id="tax_description{{$service->id}}"
                                                                                               name="tax_description"
                                                                                               value="">
                                                                                        <input type="hidden"
                                                                                               id="tax_id{{$service->id}}"
                                                                                               name="tax_id" value="">
                                                                                        <input type="hidden"
                                                                                               id="taxx{{$service->id}}"
                                                                                               name="taxx" value="">
                        ...
                        <div class="col-md-12">
                            <div class="pull-right m-t-30 text-right">
                                <div class="col-sm-12">
                                    <h3 id="total_amount"><b>Total {{ $currency }}
                                            :</b> {{ number_format($quotation->services->sum('total'), 2) }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 clearfix">
                                    <button class="btn btn-primary" onclick="addDocs()"><i class="fa fa-check"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-4 pull-right">
                                    <div class="pull-right">
                                        <button onclick="storeServiceData()" class="btn btn-primary pull-right">Add
                                            Documents
                                        </button>
                                    </div>
                                </div>
                                ...
                                @if($quotation->doc_ids != null)
                                    @foreach(json_decode($quotation->doc_ids) as $docs)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <button onclick="deleteDocs('{{ $docs->doc_id }}','{{ $quotation->id }}')"
                                                        class="btn btn-xs btn-danger">
                                                    <i class="fa fa-trash"></i>
                                                </button>
                                            </td>
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="col-sm-12">
                                    <div class="text-right">
                                        @if($quotation->status == \Esl\helpers\Constants::LEAD_QUOTATION_APPROVED)
                                            ...
                                            <div class="modal fade bs-example-modal-client" tabindex="-1" role="dialog"
                                                 aria-labelledby="myLargeModalLabel" aria-hidden="true"
                                                 style="display: none;">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="myLargeModalLabel">Message
                                                                Body</h4>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="col-12">
                                                                <form action="{{ url('/client/quotation/send/') }}"
                                                                      onsubmit="cssLoader()" method="post">
                                                                    <div class="row">
                                                                        {{ csrf_field() }}
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="row">
                                                                                    <div class="col-sm-3">
                                                                                        <label for="name">Client
                                                                                            Name</label>
                                                                                    </div>
                                                                                    <div class="col-sm-9">
                                                                                        <input type="text"
                                                                                               value="{{$quotation->customer ? $quotation->customer->Name : ''}}"
                                                                                               required id="name"
                                                                                               name="name"
                                                                                               class="form-control"
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="row">
                                                                                    <div class="col-sm-3">
                                                                                        <label for="customer_person">Contact
                                                                                            Person</label>
                                                                                    </div>
                                                                                    <div class="col-sm-9">
                                                                                        <input type="text"
                                                                                               value="{{$quotation->customer ? $quotation->customer->Contact_Person :''}}"
                                                                                               required
                                                                                               id="customer_person"
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-9">
                                                                                        <input type="text"
                                                                                               value="{{$quotation->customer ? $quotation->customer->Telephone :''}}"
                                                                                               required id="phone"
                                                                                               name="phone"
                                                                                               class="form-control"
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-9">
                                                                                        <input type="email"
                                                                                               value="{{$quotation->customer ? $quotation->customer->EMail :''}}"
                                                                                               required id="email"
                                                                                               name="email"
                                                                                               class="form-control"
                                                                            ...
                                                                            <div class="form-group">
                                                                                <input class="btn pull-right  btn btn-outline-success"
                                                                                       type="submit"
                                        ...
                                        @if($quotation->status == \Esl\helpers\Constants::LEAD_QUOTATION_ACCEPTED)
                                            ...
                                            <a href="{{ url('/quotation/convert/'.$quotation->id) }}"
                                               class="btn btn btn-primary">Start Processing</a>
                                        @endif
                                        {{--                                <a href="{{ url('/quotation/customer/accepted/'.$quotation->id) }}" class="btn btn btn-primary">Archive</a>--}}
                                        <a href="{{ url('/quotation/preview/'.$quotation->id) }}"
                                           class="btn btn btn-outline-success">Preview</a>
                                        @if($quotation->status != \Esl\helpers\Constants::LEAD_QUOTATION_ACCEPTED
                            ...
                            && $quotation->status != \Esl\helpers\Constants::LEAD_QUOTATION_CONVERTED)
                                            @if($quotation->status != \Esl\helpers\Constants::LEAD_QUOTATION_CHECKED)
                                                <a href="{{ url('/quotation/request/'.$quotation->id) }}"
                                                   class="btn btn-success" type="submit"> Request Approval </a>
                                            @endif
                                        @endif
                                    </div>
                                </div>
            ...
            @else
                <div class="col-md-offset-1 card card-body printableArea" style="padding-left: 30px !important;padding-right: 30px !important;">
                    <div class="ribbon ribbon-bookmark ribbon-right ribbon-primary">{{ $quotation->status }}</div>
                    <h3 class="text-center mb-0"> {{ucfirst($quotation->type)}} Quotation </h3>
                    <hr/>
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive" style="clear: both;">
                                ...
                                <add-service-component
                                        ...
                                        :savedquotationservices="{{$quotation->services}}"
                                ></add-service-component>
                            </div>
                        </div>
                    </div>
                    <required-quotation-documents
                            :requireddocs="{{json_encode($docs)}}"
                            :docs="{{json_encode($quotation->doc_ids) }}"
                            :quotation="{{json_encode($quotation)}}"
                    ></required-quotation-documents>

                    <quotation-remarks-component
                            :remarks="{{json_encode($quotation->remarks->sortByDesc('created_at'))}}"
                    ></quotation-remarks-component>
                </div>
                <div class="col-md-12 card card-body" style="padding-left: 30px !important;padding-right: 30px !important;">
                    <div class="row">
                        <hr>
                        <div class="col-md-12">
                            <div class="pull-right m-t-30 text-right">
                                <div class="col-sm-12">
                                    <div class="text-right">
                                        @if($quotation->status == \Esl\helpers\Constants::LEAD_QUOTATION_APPROVED)
                                            <a target="_blank" href="{{ url('/quotation/download/'.$quotation->id) }}"
                                               class="btn btn btn-outline-success">Download</a>
                                            <button data-toggle="modal" data-target=".bs-example-modal-client"
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-9">
                                                                                        <input type="text"
                                                                                               value="{{$quotation->customer->Contact_Person}}"
                                                                                               required
                                                                                               id="customer_person"
                                                                                               name="customer_person"
                                                                                               class="form-control"
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-9">
                                                                                        <input type="text"
                                                                                               value="{{$quotation->customer->Telephone}}"
                                                                                               required id="phone"
                                                                                               name="phone"
                                                                                               class="form-control"
                                                                                               placeholder="Phone Number">
                                        ...
                                        @endif
                                        @if($quotation->status == \Esl\helpers\Constants::LEAD_QUOTATION_WAITING)
                                            <a href="{{ url('/quotation/customer/accepted/'.$quotation->id) }}"
                                               onclick="cssLoader()" class="btn btn btn-primary">Accepted</a>
                                            <a href="{{ url('/quotation/customer/declined/'.$quotation->id) }}"
                                               onclick="cssLoader()" class="btn btn-danger" type="submit"> Declined </a>
                                        @endif
                                        @if($quotation->status == \Esl\helpers\Constants::LEAD_QUOTATION_ACCEPTED)
                                            <a href="{{ url('/quotation/convert/'.$quotation->id) }}"
                                               class="btn btn btn-primary">Download</a>
                                            <a href="{{ url('/quotation/convert/'.$quotation->id) }}"
                                               class="btn btn btn-primary">Start Processing</a>
                                        @endif
                                        <a href="{{ url('/quotation/customer/accepted/'.$quotation->id) }}"
