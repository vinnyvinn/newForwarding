                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="pull-right m-t-30 text-right">
                            <div class="col-sm-12">
                                <h3 id="total_amount"><b>Total (Excl) {{ $currency }}
                                        :</b> {{ number_format($quotation->services->sum('total'), 2) }}</h3>
                                <h4 id="total_amount"><b>Total Tax {{ $currency }}
                                        :</b> {{ number_format($quotation->services->sum('tax'), 2) }}</h4>
                                <h3 id="total_amount"><b>Total (Incl) {{ $currency }}
                                        :</b> {{ number_format($quotation->services->sum('total'), 2) }}</h3></div>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="text-right">
                                ...
                                @if($quotation->status == \Esl\helpers\Constants::LEAD_QUOTATION_CHECKED)
                                    @can('approve-quotation')
                                        <button class="btn btn-danger" onclick="event.preventDefault(); disapprove()">
                                            DISAPPROVE
                                        </button>
                                        <button class="btn btn-primary" onclick="event.preventDefault(); approve()">
                                            APPROVE
                                        </button>
                                    @endcan
                                @else
