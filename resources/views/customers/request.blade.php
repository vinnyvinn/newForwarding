                    ...
                    <div class="col-md-12">
                        <div class="pull-left">
                            <address>
                                ...
                                <h4 class="m-l-5"><strong>Contact Person
                                        : </strong> {{ ucwords($customer->contact_person) }}
                                    <br/> <strong>Tel/Email
                                        : </strong> {{ $customer->telephone }} {{ $customer->email }}
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#home"
                                                            ...
                                                            class="ti-home"></i></span> <span class="hidden-xs-down">Vessel Details</span></a>
                                        </li>
                                    </ul>
                                        ...
                                        <div class="tab-pane active" id="home" role="tabpanel">
                                            <div class="p-20">
                                                <form class="form-material m-t-40"
                                                      onsubmit="event.preventDefault();submitForm(this, '/vessel-details','redirect');"
                                                      action="" id="vessel">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="call_sign" name="call_sign"
                                                                       class="form-control" placeholder="Call Sign">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" id="discharge_rate"
                                                                       name="discharge_rate" class="form-control"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="port_of_discharge"> Port of
                                                                    Discharge</label>
                                                                <input type="text" id="port_of_discharge"
                                                                       name="port_of_discharge" class="form-control"
                                                                       placeholder="Port of Discharge">
                                                            </div>
                                                            <div class="form-group">

                                                                <label for="port_of_loading"> Port of Loading</label>
                                                                <input type="text" id="port_of_loading"
                                                                       name="port_of_loading" class="form-control"
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="loa" name="loa" required
                                                                       class="form-control"
                                                                       placeholder="Lenth Over All">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="grt">Gross Tonnage GRT</label>
                                                                <input type="text" id="grt" name="grt" required
                                                                       class="form-control"
                                                                       placeholder="Gross Tonnage ">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="consignee_good"> Cargo Tonnage </label>
                                                                <input type="text" id="consignee_good" required
                                                                       name="consignee_good" class="form-control"
                                                                       placeholder="Cargo Weight">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="nrt"> Net Tonnage</label>
                                                                <input type="text" id="nrt" name="nrt"
                                                                       class="form-control" placeholder="Net Tonnage">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="dwt"> Dead Weight - including
                                                                    provision</label>
                                                                <input type="text" id="dwt" name="dwt"
                                                                       class="form-control"
                                                                       placeholder="Dead Weight - including provision">
                                                            </div>
                                                            <div class="form-group">
                                                                <br>
